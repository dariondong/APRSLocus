...
class _OobePageState extends State<OobePage> {
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text('仍然继续', style: ts(13, c: C.orange, w: FontWeight.w600)),
          ),
          FilledButton(
            ...
            child: Text('去填写', style: ts(13, c: Colors.white, w: FontWeight.w700)),
          ),
        ],
      ),
    );
            ...
            child: Row(children: [
              ...
              FilledButton.icon(
                ...
                icon: Icon(last ? Icons.check_rounded : Icons.arrow_forward_rounded,
                    size: 16),
                label: Text(last ? S.of(context).finish : S.of(context).next),
                style: FilledButton.styleFrom(
                  backgroundColor: C.blue,
                  padding:
  ...
  Widget _languagePick() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        SizedBox(height: 16),
        Text(S.of(context).language, style: ts(22, w: FontWeight.w800, ls: -0.4)),
        SizedBox(height: 8),
            ...
            child: Container(
              ...
              child: Row(children: [
                Icon(Icons.language_rounded,
                    size: 18, color: on ? C.blue : C.greyLight),
                SizedBox(width: 12),
                Expanded(
                  child: Text(opt.$2,
                      style: ts(15,
  ...
  Widget _welcome() {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        AppLogo(size: 88),
        SizedBox(height: 22),
        Text(S.of(context).oobeWelcomeTitle,
            style: ts(24, w: FontWeight.w800, ls: -0.5)),
        SizedBox(height: 10),
        Text(S.of(context).aboutSubtitle,
            style: ts(14, c: C.slate, ls: 1)),
        SizedBox(height: 28),
        _feature(Icons.map_rounded, S.of(context).oobeWelcomeRealMap, '高德地图瓦片，查看附近 APRS 台站与轨迹'),
        SizedBox(height: 12),
        _feature(Icons.gps_fixed_rounded, S.of(context).oobeWelcomeGps, '自动获取位置并发送信标到 APRS-IS'),
        SizedBox(height: 12),
        _feature(Icons.chat_bubble_rounded, S.of(context).oobeWelcomeMsg, '与台站收发消息，支持自动应答'),
        SizedBox(height: 12),
        _feature(Icons.wifi_rounded, S.of(context).oobeWelcomeIs, '连接公共服务器，接收全球台站数据'),
        SizedBox(height: 20),
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(height: 4),
          Text('SSID 是呼号后面的数字标识，如 BG7ABC-9 中的 -9',
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          height: 40,
          decoration: BoxDecoration(
              color: C.blueBg, borderRadius: BorderRadius.circular(11)),
  ...
  Widget _callsign() {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        SizedBox(height: 16),
        Text(S.of(context).oobeCallTitle, style: ts(22, w: FontWeight.w800, ls: -0.4)),
        SizedBox(height: 8),
        Text(S.of(context).oobeCallDesc,
            textAlign: TextAlign.center,
        ...
        SizedBox(height: 12),
        // SSID 后缀选择（点击弹窗）
        Text('SSID 后缀（可选）', style: ts(13, w: FontWeight.w700)),
        SizedBox(height: 6),
        GestureDetector(
        ...
        Container(
          ...
          child: Text(
            '完整呼号: ${_call.text.trim().toUpperCase()}${_ssid == 0 ? '' : '-$_ssid'}',
  ...
  Widget _symbolPick() {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        SizedBox(height: 16),
        Text(S.of(context).oobeSymbolTitle, style: ts(22, w: FontWeight.w800, ls: -0.4)),
        SizedBox(height: 8),
        Text(S.of(context).oobeSymbolDesc,
            style: ts(12, c: C.slate)),
        SizedBox(height: 24),
  ...
  Widget _filterPick() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        SizedBox(height: 16),
        Text(S.of(context).oobeFilterTitle, style: ts(22, w: FontWeight.w800, ls: -0.4)),
        SizedBox(height: 8),
        Text(S.of(context).oobeFilterDesc,
            textAlign: TextAlign.center,
            style: ts(12, c: C.slate, h: 1.6)),
        SizedBox(height: 24),
        ...entries.map((e) {
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(
                  ...
                  children: [
                    Text('其他台站', style: ts(13, w: FontWeight.w700)),
                    SizedBox(height: 2),
  ...
  Widget _serverPage() {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        SizedBox(height: 16),
        Text(S.of(context).oobeServerTitle, style: ts(22, w: FontWeight.w800, ls: -0.4)),
        SizedBox(height: 8),
        Text(S.of(context).oobeServerDesc,
            textAlign: TextAlign.center,
            style: ts(12, c: C.slate, h: 1.6)),
        SizedBox(height: 24),
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              SizedBox(width: 6),
              Text('Passcode 非常重要', style: ts(12, c: C.red, w: FontWeight.w700)),
            ]),
            SizedBox(height: 6),
            Text(
              '正确的 Passcode 是接收群聊消息和发送确认消息的前提。'
              '填 -1 虽然可以连接，但无法正常收发消息。',
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  SizedBox(width: 6),
                  Text('点击查询你的 Passcode →', style: ts(12, c: C.red, w: FontWeight.w700)),
                ]),
              ),
            ),
            SizedBox(height: 6),
            Text('输入你的呼号即可获取，例如 BV2AAA', style: ts(10, c: C.grey)),
          ]),
        ),
      ]),
    );
  ...
  Widget _field(String label, TextEditingController ctrl, String hint) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(label, style: ts(11, c: C.slate, w: FontWeight.w600)),
      SizedBox(height: 6),
      TextField(
        controller: ctrl,
