...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get guideImmersiveBody => '全画面の地図です。ピンチで拡大縮小、ドラッグで移動、左下で「自分を追従」を切り替え、左上で戻ります。';

  @override
  String get guideMessagesTitle => 'メッセージ';

  @override
  String get guideMessagesBody => 'コールサインを入力すると会話を開始できます。右上のメニューでグループ作成・一斉送信ができます。返信が来ないときは接続状態を確認してください。';

  @override
  String get guideDeviceTitle => 'デバイスとデータソース';

  @override
  String get guideDeviceBody => 'データの取得元（APRS-IS / TNC / サウンドカード）と送信に使う回線を選びます。Bluetooth TNC は先にデバイスの子ページでペアリングしてください。';

  @override
  String get guideSettingsTitle => '設定';

  @override
  String get guideSettingsBody => '8 つのカテゴリ：無線機、ビーコン、接続、表示、デバイス、データ、詳細、更新。変更はすぐ反映されます。';

  @override
  String get guideOfflineMapTitle => 'オフラインマップ';

  @override
  String get guideOfflineMapBody => '範囲を選んでタイルを保存すると、通信がなくても地図が見られます。中断しても後から再開できます。';

  @override
  String get guideLogTitle => 'システムログ';

  @override
  String get guideLogBody => '送受信パケットと回線のイベントが記録されます。不具合の切り分けはまずここから。右上で全文をコピーできます。';

  @override
  String get guideBackupTitle => 'バックアップと復元';

  @override
  String get guideBackupBody => '設定ファイルを書き出せば、機種変更後にワンタップで復元できます。タイルと翻訳キャッシュは含まれません。';

  @override
  String get guideExportAdifTitle => 'ADIF 書き出し';

  @override
  String get guideExportAdifBody => '受信した局の位置を ADIF ファイルに書き出し、ログソフトへ取り込めます。期間とモードを指定できます。';
