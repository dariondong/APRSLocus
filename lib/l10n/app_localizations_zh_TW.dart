...
class AppLocalizationsZhTw extends AppLocalizations {
  ...
  @override
  String get filter => '接收範圍過濾';

  @override
  String get filterRadius => '過濾半徑(km)';
  ...
  @override
  String get searchHint => '搜尋呼號 / 型別 / 網格 / 備註…';
  ...
  @override
  String get restartWizard => '重新執行設定嚮導';

  @override
  String get restartWizardTitle => '重新執行設定嚮導？';
  ...
  @override
  String get oobeWelcomeRealMap => '實時地圖';
  ...
  @override
  String get filterRule => '過濾規則';

  @override
  String get saveAndApply => '儲存並應用過濾';

  @override
  String get useMyLocation => '用我的位置作為過濾中心';

  @override
  String get noFixYet => '尚未定位，無法獲取當前位置';

  @override
  String get invalidCoords => '請輸入有效的經緯度和半徑';

  @override
  String get filterSaved => '過濾已儲存並應用';

  @override
  String get stationsShown => '臺站';

  @override
  String get settingsDesc => '配置電臺、定位與連線';
  ...
  @override
  String get connectionCatDesc => '伺服器 · 過濾範圍';
  ...
  @override
  String get oobeWelcomeDesc => '開始配置你的 APRS 電臺';

  @override
  String get oobeCallDesc => '輸入你的呼號';

  @override
  String get oobeSymbolDesc => '符號代表臺站型別，會隨位置信標一起傳送';

  @override
  String get oobeServerDesc => '連線後接收全球 APRS 臺站資料，可保持預設配置直接使用';

  @override
  String get wizard => '設定嚮導';
  ...
  @override
  String get dataSettingsSubtitle => '本地資料管理';

  @override
  String get advancedSettingsSubtitle => '實驗室與開發者工具';

  @override
  String get stationListTitle => '臺站列表';
  ...
  @override
  String get mapTypeTitle => '地圖型別';

  @override
  String get selectMapType => '選擇地圖型別';
  ...
  String get oobeAgreeBody => '歡迎使用 APRSlocus！在使用前，請閱讀並同意以下條款。請注意：APRS 資料是公開資訊，一旦傳送即代表其可能被全球 APRS 網路接收、儲存與轉發。';
  String get oobeAgreeCheck => '我已閱讀並同意《使用者協議》與 GPL-3.0 開源許可證';
  String get oobeAgreeNeed => '請先閱讀並勾選同意《使用者協議》';
  String get oobeDeclineExit => '不同意並退出';
  String get userAgreement => '使用者協議';
  String get beaconWarnTitle => '信標間隔過短';
  String get beaconWarnBody => 'APRS-IS 建議移動站信標間隔不低於 60 秒。過快的上報可能被視為濫用並導致伺服器斷開連線。是否仍要使用該間隔？';
  ...
  @override
  String get copyAppInfo => '複製應用資訊';

  @override
  String get appInfoCopied => '已複製應用資訊';
  ...
  @override
  String get shareToSystemDesc => '微信 / QQ / 簡訊等';
  ...
  @override
  String get noMatchingPackets => '沒有匹配的資料包';
  ...
  @override
  String get mapHelpLayer => '圖層與底圖：右上角按鈕篩選臺站型別、切換地圖樣式';

  @override
  String get mapHelpLocate => '定位：點選右下角「定位到我」回到當前位置';
  ...
  @override
  String get featureAutoConnectDesc => '公共伺服器自動連線，後臺保持線上';

  @override
  String get featureLayerFilter => '圖層篩選';

  @override
  String get featureLayerFilterDesc => '按型別篩選：移動、固定、中繼、氣象、FMO';
  ...
  @override
  String get osFlutterDesc => 'Google 跨平臺 UI 框架';
  ...
  @override
  String get donateWechat => '微信讚賞';

  @override
  String get donateWechatDesc => '長按儲存讚賞碼 · 點選放大';

  @override
  String get donateAlipay => '支付寶讚賞';
  ...
  @override
  String get mapTypeDesc => '「地圖 2.0（向量）」使用客戶端實時向量渲染，資料量小、縮放清晰；高德向量/衛星為線上柵格瓦片。';
  ...
  @override
  String get contactDesc => '訊息/聯絡人相關的過濾規則';

  @override
  String get dataClearDesc => '清除訊息、資料包、臺站等本地資料';

  @override
  String get advancedDesc => '實驗室與開發者工具';

  @override
  String get labDesc => '實驗室功能仍在測試中，可能影響使用體驗。預設鎖定豎屏，開啟後支援橫屏。';
  ...
  @override
  String get simData => '啟用模擬資料（演示臺站/資料包）';
  ...
  @override
  String get clearStations => '清除臺站列表';
  ...
  @override
  String get resetAllDesc => '恢復出廠設定';
  ...
  @override
  String get appVersionDesc => '當前應用版本';
  ...
  @override
  String get deletePackage => '刪除安裝包';
  ...
  @override
  String get deleteAllPackages => '刪除全部安裝包';
  ...
  @override
  String get latestVersion => '當前已是最新版本';

  @override
  String get currentVersion => 'APRSlocus 當前版本';
  ...
  @override
  String get noUpdateFound => '當前已是最新版本';

  @override
  String get newVersionFound => '發現新版本';

  @override
  String get downloadAgain => '重新下載安裝包';
  ...
  @override
  String get alreadyDownloaded => '安裝包已下載';

  @override
  String get downloadReady => '下載一份安裝包';
  ...
  @override
  String get groupTracking => '群組跟蹤';

  @override
  String get groupTrackingHint => '把關心的呼號編成組，在大地圖上持續跟蹤（車隊 / 好友結伴），支援橫屏。';

  @override
  String get newTrackGroup => '新建跟蹤組';

  @override
  String get trackGroupNameHint => '組名，如：週末騎行';

  @override
  String get editTrackGroup => '編輯跟蹤組';

  @override
  String get deleteTrackGroup => '刪除跟蹤組';

  @override
  String deleteTrackGroupConfirm(Object name) => '確定刪除跟蹤組「$name」嗎？';

  @override
  String get pickTrackMembers => '選擇成員（勾選要跟蹤的呼號）';

  @override
  String get saveAndTrack => '儲存並跟蹤';

  @override
  String get trackGroupsEmptyHint => '還沒有跟蹤組，點「新建跟蹤組」建立一組要跟蹤的呼號。';

  @override
  String trackMemberSub(Object type, Object seen) => '$type · $seen';

  @override
  String get trackGroupEmpty => '組內成員暫無位置資料（未收到或未上報），點選下方可編輯成員。';
  ...
  @override
  String get chatToGroupHint => '發訊息給全群…';

  @override
  String chatToHint(Object call) => '發給 $call…';

  @override
  String get noMessagesHint => '暫無訊息，發一條吧';

  @override
  String trackModeFollow(Object call) => '跟隨 $call';
  ...
  @override
  String get navigationUnavailable => '未安裝高德地圖，且無法開啟其他地圖應用';
  ...
  @override
  String get broadcastMessage => '群發訊息';
  ...
  @override
  String get addContactDesc => '輸入呼號手動新增到聯絡人列表';
  ...
  @override
  String get webLocationUnsupported => 'Web 平臺暫不支援自動定位，請手動輸入座標';
  ...
  @override
  String get applyCoordinates => '應用座標';
  ...
  @override
  String get passcodeTip => 'APRS-IS 登入驗證碼，可線上生成；填 -1 表示未驗證';
  ...
  @override
  String get connectFailedCheckConfig => '連線失敗，請檢查配置';

  @override
  String get rangeFilterDesc => '只接收設定範圍內的臺站資料包';

  @override
  String get filterCenterFollows => '過濾中心跟隨我的位置';

  @override
  String get radiusTip => '接收半徑（km），點“儲存並應用”生效';
  ...
  @override
  String get receiveFilterDesc2 => '除範圍過濾外，按國家/地區分組或精確呼號接收臺站';
  ...
  @override
  String get receiveOthersDesc => '接收不匹配所選國家的特殊呼號臺站';
  ...
  @override
  String get clearAllDataIntro => '此操作將刪除以下所有本地資料：';
  ...
  @override
  String get irreversibleKeepSettings => '此操作不可恢復，連線設定和呼號不會被刪除。';

  @override
  String get confirmClearAllData => '確認清除所有資料';

  @override
  String get clearAllDataConfirm => '確定要清除全部本地資料嗎？此操作不可恢復。';
  ...
  @override
  String get parseAndApply => '解析並應用';
  ...
  @override
  String get oobeMapFeatureDesc => '高德地圖瓦片，檢視附近 APRS 臺站與軌跡';

  @override
  String get oobeGpsFeatureDesc => '自動獲取位置併傳送信標到 APRS-IS';

  @override
  String get oobeMsgFeatureDesc => '與臺站收發訊息，支援自動應答';

  @override
  String get oobeIsFeatureDesc => '連線公共伺服器，接收全球檯站資料';
  ...
  @override
  String get oobeNextSteps => '接下來幾步完成基礎配置，隨時可在設定中修改。';
  ...
  @override
  String get passcodeLookupHint => '輸入你的呼號即可獲取，例如 BV2AAA';
  ...
  @override
  String get qrSaveWechat => '長按圖片可儲存 · 微信掃一掃讚賞';
  ...
  @override
  String get invalidResponseData => '返回資料格式錯誤';

  @override
  String get noVersionsFound => '沒有找到任何版本';

  @override
  String get noWindowsInstaller => '該版本沒有 Windows 安裝包';

  @override
  String get noApkInstaller => '該版本沒有 APK 安裝包';
  ...
  @override
  String get cannotLaunchInstaller => '無法啟動安裝器，請手動開啟安裝包';

  @override
  String get openPackageManually => '請在檔案管理器中開啟安裝包';
  ...
  @override
  String get installPermissionTitle => '需要允許安裝應用';
  ...
  @override
  String get downloadInstaller => '下載安裝包';

  @override
  String get downloadAndInstall => '下載並安裝';

  @override
  String get localPackageExists => '本地已有一份安裝包';

  @override
  String get packageDeleted => '安裝包已刪除';
  ...
  @override
  String get settingsDisplayInfoSubtitle => '我的符號與當前定位';
  ...
  @override
  String get settingsMapSubtitle => '地圖型別與顯示';
  ...
  @override
  String get settingsClearDataSubtitle => '刪除本地記錄';
  ...
  @override
  String get settingsReceivePrefHint => '除範圍過濾外，按國家/地區分組或精確呼號接收臺站';
  ...
  String get beaconAutoAskDesc =>
      '是否讓 APRSlocus 在連線後自動定時上報你的位置（信標）？移動台建議開啟；若只想接收訊息與看周邊臺站，可關閉（隨時可手動上報一次）。';
