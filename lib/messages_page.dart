...
class _MessagesPageState extends State<MessagesPage> {
  ...
  List<String> _partners(AppState st) {
    ...
    for (final m in st.messages) {
      ...
      final isGroupCall = st.chatGroups.any((g) =>
  ...
  List<AprsMsg> _chatWith(AppState st, String call) =>
      st.messages.where((m) {
        // 排除群聊消息
  ...
  List<(AprsMsg, String)> _groupMessages(AppState st, {ChatGroup? group}) {
    ...
    for (final m in st.messages) {
      ...
      if (group == null) {
        ...
        if (m.sent) {
          if (members.contains(m.to)) result.add((m, '我'));
        } else {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        if (_selected.isEmpty && partners.isNotEmpty) _selected = partners.first;
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(
                    child: _feedMode
                        ? _feedPane(st)
                        : narrow
                            ? (_showList ? _listPane(st, partners) : _chatPane(st))
                            : Row(
                                crossAxisAlignment: CrossAxisAlignment.stretch,
                                children: [
                                  SizedBox(width: 280, child: _listPane(st, partners)),
      ...
      child: Column(children: [
        ...
        Expanded(
          child: st.messages.isEmpty
              ? Center(
                  child: Text('暂无消息', style: TextStyle(color: C.grey, fontSize: 13)))
              : ListView.builder(
  ...
  Widget _feedBubble(AprsMsg m) {
    ...
    if (m.groupId != null) {
      for (final g in widget.state.chatGroups) {
        if (g.id == m.groupId) { groupName = g.name; break; }
      }
    }
    return GestureDetector(
      onLongPress: () {
      ...
      child: Container(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('${m.time.hour.toString().padLeft(2, '0')}:'
              ...
              Row(children: [
                if (m.groupId != null)
                  Container(
                    ...
                    child: Text(groupName ?? '群',
                        style: ts(8, c: C.orange, w: FontWeight.w700)),
                  ),
                Text(mine ? '→ ${m.to}' : '← ${m.from}',
                    style: ts(10,
                        c: mine ? C.blue : C.green, w: FontWeight.w700)),
        ...
        children: [
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              // 快捷操作：新建会话 / 群发 / 新建群聊
              Row(children: [
                _convActionBtn(Icons.add_comment_rounded, '新建会话', C.blue, () {
                ...
                SizedBox(width: 6),
                _convActionBtn(Icons.group_add_rounded, S.of(context).newGroup, C.orange, () {
          ...
          Expanded(
            child: st.chatGroups.isEmpty && partners.isEmpty
                ? Center(child: Text('暂无会话', style: ts(12, c: C.grey)))
                : ListView.builder(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            left: BorderSide(
                color: sel ? C.orange : Colors.transparent, width: 3),
          ),
        ),
        child: Row(children: [
          Container(
              ...
              children: [
                Row(children: [
                  ...
                  Container(
                    ...
                    child: Text('群', style: ts(8, c: C.orange, w: FontWeight.w700)),
                  ),
                ]),
                SizedBox(height: 1),
                Text(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            left: BorderSide(
                color: sel ? C.blue : Colors.transparent, width: 3),
          ),
        ),
        child: Row(children: [
          Container(
  ...
  Widget _chatPane(AppState st) {
    ...
    if (_selectedGroupId != null) {
      final group = st.chatGroups.where((g) => g.id == _selectedGroupId).firstOrNull;
      if (group == null) {
        _selectedGroupId = null;
        return Center(child: Text('群聊不存在', style: ts(13, c: C.grey)));
      }
      ...
      return SoftCard(
        ...
        child: Column(children: [
          Container(
            ...
            child: Row(children: [
              GestureDetector(
                onTap: () => setState(() { _selectedGroupId = null; _showList = true; }),
              ...
              if (group.isOwner(st.myCall))
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Icon(Icons.person_add_rounded, size: 12, color: C.green),
                      SizedBox(width: 3),
                      Text('邀请', style: ts(10, c: C.green, w: FontWeight.w600)),
                    ]),
                  ),
                ),
              SizedBox(width: 6),
              ...
              if (!group.isOwner(st.myCall))
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text('退出', style: ts(10, c: C.red, w: FontWeight.w600)),
                  ),
                ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text('管理', style: ts(10, c: C.blue, w: FontWeight.w600)),
                ),
              ),
            ]),
          ),
          Expanded(
            child: msgs.isEmpty
                ? Center(child: Text('群聊暂无消息', style: ts(13, c: C.grey)))
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return _bubble(msg, groupSender: sender,
        ...
        ? Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text('选择会话开始聊天', style: ts(14, c: C.grey)),
              ],
            ),
          )
        : SoftCard(
            ...
            child: Column(children: [
              Container(
                ...
                child: Row(children: [
                    ...
                    child: Row(children: [
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            _selected.length >= 2
                                ? _selected.substring(_selected.length - 2)
                                : _selected,
                  ...
                  SizedBox(width: 12),
                  Text(_partnerGrid(st, _selected),
              ...
              Expanded(
                child: ListView(
                  ...
                  padding: const EdgeInsets.all(14),
                  children:
                      _chatWith(st, _selected).map((m) => _bubble(m)).toList(),
                ),
              ),
              _inputBar(st),
            ]),
  ...
  static final _memberColors = [
    C.blue, C.green, C.orange, C.purple, Color(0xFF0D9488), Color(0xFFDB2777), Color(0xFFB45309),
  ];
  ...
  /// 会话页快捷操作按钮
  Widget _convActionBtn(IconData icon, String label, Color color, VoidCallback onTap) {
    return Expanded(
      child: GestureDetector(
        onTap: onTap,
        child: Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(label, style: ts(11, c: color, w: FontWeight.w700)),
          ]),
        ),
      ),
    );
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) {
          ...
          final suggestions = q.isEmpty
              ? <Station>[]
              : st.stations
                  .where((s) => s.call.toUpperCase().contains(q) &&
          ...
          return AlertDialog(
            ...
            title: Text('新建会话', style: ts(16, w: FontWeight.w700)),
            content: SizedBox(
              width: 320,
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Text('输入呼号开始新的会话', style: ts(12, c: C.grey)),
                SizedBox(height: 12),
                TextField(
                  controller: ctrl,
                  autofocus: true,
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            ...
                            SizedBox(width: 8),
                            Text(s.call, style: ts(13, w: FontWeight.w600)),
                            Spacer(),
            ...
            actions: [
              ...
              FilledButton(
                ...
                child: Text('开始', style: ts(13, c: Colors.white, w: FontWeight.w700)),
              ),
            ],
          );
        },
        ...
        builder: (ctx, setDialogState) {
          ...
          return AlertDialog(
            ...
            title: Row(children: [
              ...
              SizedBox(width: 8),
              Expanded(child: Text('群发消息', style: ts(16, w: FontWeight.w700))),
              // 步骤指示
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                decoration: BoxDecoration(
                ...
                child: Text('$step/2', style: ts(11, c: C.purple, w: FontWeight.w700)),
              ),
            ]),
            content: SizedBox(
              ...
              child: Column(children: [
                ...
                if (step == 1) ...[
                  ...
                  SizedBox(height: 6),
                  Row(children: [
                    _pickerActionBtn('全选在线', Icons.check_circle_outline_rounded, () {
                      setDialogState(() {
                        for (final s in list) {
                          if (s.status != St.offline) selected.add(s.call);
                        }
                      });
                    }),
                    SizedBox(width: 6),
                    ...
                    Spacer(),
                    GestureDetector(
                      onTap: () => setDialogState(() => onlyOnline = !onlyOnline),
                      child: Container(
                        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                        decoration: BoxDecoration(
                          color: onlyOnline ? C.purple.withValues(alpha: 0.12) : C.bgSoft,
                          borderRadius: BorderRadius.circular(6),
                        ),
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          Icon(onlyOnline ? Icons.filter_list_rounded : Icons.filter_list_off_rounded,
                              size: 14, color: onlyOnline ? C.purple : C.grey),
                          SizedBox(width: 3),
                          Text(onlyOnline ? '仅在线' : S.of(context).all, style: ts(10, c: onlyOnline ? C.purple : C.grey)),
                        ]),
                      ),
                    ),
                  ]),
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: ts(11, c: selected.isEmpty ? C.grey : C.purple, w: FontWeight.w700),
                    ),
                  ),
                  SizedBox(height: 6),
                  Expanded(
                    child: list.isEmpty
                        ? Center(child: Text('暂无台站', style: ts(12, c: C.grey)))
                        : ListView.builder(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return GestureDetector(
                                onTap: () => setDialogState(() {
                                  if (sel) selected.remove(s.call);
                                  else selected.add(s.call);
                                }),
                                child: Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 7),
                                  child: Row(children: [
                                    Icon(sel ? Icons.check_circle_rounded : Icons.radio_button_unchecked_rounded,
                                        size: 20, color: sel ? C.purple : C.greyLight),
                                    SizedBox(width: 10),
                                    Text(s.call, style: ts(13, w: FontWeight.w600)),
                                    Spacer(),
                                    Text(s.typeName, style: ts(10, c: C.grey)),
            ...
            actions: [
              TextButton(
                ...
                child: Text(step == 1 ? S.of(context).cancel : S.of(context).previous,
              ...
              if (step == 1)
                FilledButton(
                  ...
                  child: Text(S.of(context).next, style: ts(13, c: Colors.white, w: FontWeight.w700)),
                )
              else
                FilledButton(
                  style: FilledButton.styleFrom(
                  ...
                  onPressed: msgCtrl.text.trim().isEmpty
                      ...
                      : () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('已群发给 ${selected.length} 人'),
                              backgroundColor: C.purple,
                              duration: const Duration(seconds: 2),
                            ),
                          );
                        },
                  child: Text(S.of(context).send, style: ts(13, c: Colors.white, w: FontWeight.w700)),
                ),
            ],
          );
        },
  ...
  void _showCreateGroupDialog(AppState st) {
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) {
          var list = st.stations.where((s) => s.call != st.myFullCall).toList();
          if (onlyOnline) list = list.where((s) => s.status != St.offline).toList();
          final q = searchCtrl.text.trim().toUpperCase();
          if (q.isNotEmpty) list = list.where((s) => s.call.toUpperCase().contains(q)).toList();
          list.sort((a, b) {
            if (a.status == St.online && b.status != St.online) return -1;
            if (a.status != St.online && b.status == St.online) return 1;
            return a.call.compareTo(b.call);
          ...
          return AlertDialog(
            ...
            title: Row(children: [
              ...
              SizedBox(width: 8),
              Expanded(child: Text(S.of(context).newGroup, style: ts(16, w: FontWeight.w700))),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                decoration: BoxDecoration(
                ...
                child: Text('$step/2', style: ts(11, c: C.orange, w: FontWeight.w700)),
              ),
            ]),
            content: SizedBox(
              width: double.maxFinite,
                ...
                if (step == 1) ...[
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: '输入群聊名称',
                      hintStyle: ts(13, c: C.greyLight),
                      prefixIcon: Icon(Icons.group_rounded, size: 18, color: C.orange),
                      filled: true,
                      fillColor: C.bgSoft,
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                    ...
                    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: ts(11, c: C.orange, w: FontWeight.w500, h: 1.4),
                        ),
                      ),
                    ]),
                  ),
                ...
                if (step == 2) ...[
                  ...
                  Row(children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          Icon(onlyOnline ? Icons.filter_list_rounded : Icons.filter_list_off_rounded,
                              size: 14, color: onlyOnline ? C.blue : C.grey),
                          SizedBox(width: 3),
                          Text(onlyOnline ? '仅在线' : S.of(context).all, style: ts(10, c: onlyOnline ? C.blue : C.grey)),
                        ]),
                      ),
                    ),
                  ]),
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: ts(11, c: selected.isEmpty ? C.grey : C.orange, w: FontWeight.w700),
                    ),
                  ),
                  SizedBox(height: 8),
                  Expanded(
                    child: list.isEmpty
                        ? Center(child: Text('暂无台站', style: ts(13, c: C.grey)))
                        : ListView.builder(
                            itemCount: list.length,
                            itemBuilder: (_, i) {
                              final s = list[i];
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Row(children: [
                                    Icon(sel ? Icons.check_circle_rounded : Icons.radio_button_unchecked_rounded,
                                        size: 20, color: sel ? C.orange : C.greyLight),
                                    SizedBox(width: 10),
                                    Text(s.call, style: ts(13, w: FontWeight.w600)),
                                    Spacer(),
                                    Text(s.typeName, style: ts(10, c: C.grey)),
            ...
            actions: [
              ...
              if (step == 1)
                ...
                FilledButton(
                  ...
                  child: Text('创建', style: ts(13, c: Colors.white, w: FontWeight.w700)),
                ),
            ],
          );
        },
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx, scrollCtrl) => StatefulBuilder(
          builder: (ctx, setSheetState) {
            ...
            allMembers.removeWhere((m) => m.toUpperCase() == st.myFullCall.toUpperCase());
                ...
                child: Column(children: [
                  ...
                  Row(children: [
                    Container(
                      ...
                      child: Icon(Icons.group_rounded, color: C.orange, size: 22),
                    ),
                    SizedBox(width: 12),
                    Expanded(child: Column(
                      ...
                      children: [
                        ...
                        Text('群呼号: ${group.groupCall}', style: ts(12, c: C.orange, w: FontWeight.w600)),
                      ],
                    )),
                    GestureDetector(
                      onTap: () {
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.delete_outline_rounded, color: C.red, size: 18),
                      ),
                    ),
                  ]),
                  SizedBox(height: 12),
              ...
              Expanded(
                child: allMembers.isEmpty
                    ? Center(child: Column(
                        ...
                        children: [
                          Icon(Icons.group_off_rounded, size: 48, color: C.greyLight),
                          SizedBox(height: 8),
                          Text('暂无成员', style: ts(13, c: C.grey)),
                          SizedBox(height: 4),
                          Text('点击下方「邀请成员」添加', style: ts(11, c: C.greyLight)),
                        ],
                      ))
                    : ListView.builder(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          if (status == GroupMemberStatus.joined) {
                            ...
                            statusText = isOnlineStation ? S.of(context).online : S.of(context).offline;
                          ...
                          return Container(
                            ...
                            child: Row(children: [
                              ...
                              Expanded(child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(call, style: ts(14, w: FontWeight.w600)),
                                  const SizedBox(height: 2),
                                  Text(statusText, style: ts(11, c: statusColor)),
                                ],
                              )),
                              // 操作按钮
                              GestureDetector(
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Icon(Icons.person_add_rounded, size: 16, color: C.orange),
                            SizedBox(width: 6),
                            Text('邀请成员', style: ts(13, c: C.orange, w: FontWeight.w700)),
                          ]),
                        ),
                      ),
                    ),
  ...
  void _showDeleteGroupConfirm(AppState st, ChatGroup group) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: Colors.white,
        title: Text('删除群组', style: ts(16, w: FontWeight.w700)),
        content: Text('确定删除「${group.name}」？此操作不可撤销。', style: ts(13)),
        actions: [
          TextButton(
          ...
          FilledButton(
            ...
            onPressed: () {
              ...
              Navigator.pop(ctx);
              setState(() { _selectedGroupId = null; _showList = true; });
            },
            child: Text('删除', style: ts(13, c: Colors.white, w: FontWeight.w700)),
          ),
        ],
      ),
    );
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setSheetState) {
          ...
          final members = allMembers.where((m) =>
              m.toUpperCase() != st.myFullCall.toUpperCase()).toList()..sort();
          final onlineCount = members.where((m) =>
              st.stations.any((s) =>
                  s.call.toUpperCase() == m.toUpperCase() && s.status == St.online)).length;
              ...
              children: [
                ...
                Row(children: [
                  ...
                  Expanded(child: Column(
                    ...
                    children: [
                      Text(group.name, style: ts(16, w: FontWeight.w700)),
                      Text('${members.length} 名成员 · $onlineCount 在线',
                ...
                Flexible(
                  child: members.isEmpty
                      ? Padding(
                          ...
                          child: Center(
                            child: Text('暂无成员', style: ts(13, c: C.grey)),
                          ),
                        )
                      : ListView.builder(
                          shrinkWrap: true,
                          ...
                          itemBuilder: (_, i) {
                            ...
                            return ListTile(
                              ...
                              leading: CircleAvatar(
                                radius: 16,
                                backgroundColor: isOnline ? C.greenBg : C.bgSoft,
                                child: Icon(
                                  isOnline ? Icons.person_rounded : Icons.person_off_outlined,
                                  size: 18,
                              ...
                              title: Row(children: [
                                ...
                                if (isOwner) ...[
                                  ...
                                  Container(
                                    ...
                                    child: Text('群主', style: ts(9, c: C.orange, w: FontWeight.w700)),
                                  ),
                                ],
                              ]),
                              subtitle: Text(isOnline ? S.of(context).online : S.of(context).offline,
  ...
  void _showLeaveGroupConfirm(AppState st, ChatGroup group) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: Colors.white,
        title: Text('退出群组', style: ts(16, w: FontWeight.w700)),
        content: Text('确定退出「${group.name}」？你将不再收到该群的消息。', style: ts(13)),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx),
            child: Text(S.of(context).cancel, style: ts(13, c: C.grey)),
          ...
          FilledButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('已退出 ${group.name}'),
                  duration: const Duration(seconds: 2),
                ),
              );
            },
            child: Text('退出', style: ts(13, c: Colors.white, w: FontWeight.w700)),
          ),
        ],
      ),
    );
  ...
  void _showInviteMemberDialog(AppState st, ChatGroup group) {
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) {
          var list = st.stations.where((s) =>
              s.call != st.myFullCall &&
              !group.confirmedMembers.contains(s.call.toUpperCase()) &&
              !group.memberStatus.containsKey(s.call.toUpperCase())).toList();
          list = list.where((s) => s.status != St.offline).toList();
          final q = searchCtrl.text.trim().toUpperCase();
          if (q.isNotEmpty) list = list.where((s) => s.call.toUpperCase().contains(q)).toList();
          ...
          return AlertDialog(
            backgroundColor: Colors.white,
            title: Text('邀请成员到 ${group.name}', style: ts(15, w: FontWeight.w700)),
            content: SizedBox(
              width: double.maxFinite,
              height: MediaQuery.of(context).size.height * 0.45,
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Text('群呼号: ${group.groupCall}', style: ts(11, c: C.orange, w: FontWeight.w600)),
                SizedBox(height: 8),
                TextField(
                  controller: searchCtrl,
                  onChanged: (_) => setDialogState(() {}),
                ...
                Row(children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      if (call.isNotEmpty && call.length >= 3) {
                        widget.state.sendInvite(group.groupCall, call, group.name);
                        manualCtrl.clear();
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('已发送邀请给 $call'), duration: const Duration(seconds: 2)),
                        );
                      }
                    },
                    child: Container(
                      ...
                      child: Text('邀请', style: ts(11, c: C.orange, w: FontWeight.w700)),
                    ),
                  ),
                ]),
                SizedBox(height: 8),
                Expanded(
                  child: list.isEmpty
                      ? Center(child: Text('暂无更多在线台站', style: ts(12, c: C.grey)))
                      : ListView.builder(
                          itemCount: list.length,
                          itemBuilder: (_, i) {
                            final s = list[i];
                            final invited = group.memberStatus.containsKey(s.call.toUpperCase());
                            return GestureDetector(
                              onTap: invited ? null : () {
                                widget.state.sendInvite(group.groupCall, s.call, group.name);
                                setDialogState(() {});
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('已发送邀请给 ${s.call}'), duration: const Duration(seconds: 2)),
                                );
                              },
                              child: Container(
                                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 8),
                                child: Row(children: [
                                  Icon(invited ? Icons.check_circle_rounded : Icons.radio_button_unchecked_rounded,
                                      size: 18, color: invited ? C.green : C.greyLight),
                                  SizedBox(width: 10),
                                  Text(s.call, style: ts(13, w: FontWeight.w600)),
                                  Spacer(),
                                  if (invited)
                                    Text('已邀请', style: ts(10, c: C.green))
                                  else
                                    Text('点击邀请', style: ts(10, c: C.orange)),
                                ]),
                              ),
                            );
                          },
            ...
            actions: [
              TextButton(
                onPressed: () => Navigator.pop(ctx),
                child: Text('完成', style: ts(13, c: C.blue)),
              ),
            ],
          );
        },
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return ListTile(
                          dense: true,
                          leading: Icon(
                            s.favorite ? Icons.star_rounded : Icons.radio_rounded,
                            size: 16,
                            color: s.favorite ? C.orange : C.blue,
                          ),
                          title: Text(s.call, style: ts(13, w: FontWeight.w600)),
                          subtitle: Text(s.status == St.offline ? S.of(context).offline : S.of(context).online,
                              style: ts(10, c: C.grey)),
              ...
              FilledButton(
                onPressed: () {
                  ...
                  if (call.isNotEmpty) {
                    ...
                    Navigator.pop(context);
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('已添加联系人 $call'), duration: const Duration(seconds: 1)),
                    );
                  }
                },
                style: FilledButton.styleFrom(
                ...
                child: Text('添加', style: ts(13, c: Colors.white, w: FontWeight.w600)),
              ),
            ],
          );
        },
  ...
  void _send() {
    ...
    if (_selectedGroupId != null) {
      final group = widget.state.chatGroups
          .where((g) => g.id == _selectedGroupId).firstOrNull;
      if (group != null) {
