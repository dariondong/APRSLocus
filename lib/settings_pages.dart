...
class _StationSettingsPageState extends State<StationSettingsPage> {
  ...
  Widget _symbolPicker() {
    ...
    final cur =
        found ??
        syms.firstWhere((s) => s.$1 == st.mySymbol, orElse: () => syms.first);
    return GestureDetector(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 6),
                Text(
                  localizedAprsSymbolName(context, cur.$1),
          ...
          children: [
            ...
            Expanded(
              child: GridView.count(
                ...
                children: [for (final s in syms) _symTile(ctx, s)],
              ),
            ),
            Container(
                ...
                children: [
                  for (final cat in _symCategories) ...[
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 6),
                          Text(
                            localizedSymbolCategory(context, cat.$1),
                            style: ts(13, c: C.blue, w: FontWeight.w700),
                          ),
                        ],
                      ),
                    ...
                    GridView.count(
                      ...
                      crossAxisSpacing: 8,
                      childAspectRatio: 0.85,
                      children: [for (final s in cat.$2) _symTile(ctx, s)],
                    ),
        ...
        body: Column(
          children: [
            ...
            SettingsSectionCard(
              ...
              children: [
                SettingsSwitch(
                  S.of(context).beaconEnabled,
                  value: st.beaconEnabled,
                  onChanged: st.setBeaconEnabled,
                ),
                SettingsInput(
                  S.of(context).beaconInterval,
                  _interval,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      Text(
                        S.of(context).beaconContentDesc,
                        style: ts(10, c: C.slate),
                      ),
                      SizedBox(height: 4),
                      SettingsMiniSwitch(
                        S.of(context).speed,
                        value: st.beaconIncludeSpeed,
                        onChanged: st.setBeaconIncludeSpeed,
                      ),
                      SettingsMiniSwitch(
                        S.of(context).bearing,
                        value: st.beaconIncludeCourse,
                        onChanged: st.setBeaconIncludeCourse,
                      ),
                      SettingsMiniSwitch(
                        S.of(context).phoneBattery,
                ...
                SettingsRow2(
                  S.of(context).locationStatus,
                  localizedLocationStatus(context, st.locStatus),
                ),
                SettingsRow2(
                  S.of(context).beaconsSent,
                  S.of(context).countTimes(st.beaconsSent),
                ),
                SettingsRow2(
                  S.of(context).nextBeacon,
                  localizedNextBeaconValue(context, st.nextBeaconIn),
                ),
                if (!st.loc.running)
                  Padding(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text(
                          S.of(context).trackingBeaconing,
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  S.of(context).myLocationSetGrid(st.myGrid),
                                ),
                              ),
                            );
                          },
                      ...
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          style: OutlinedButton.styleFrom(
                            ...
                            side: BorderSide(
                              color: C.orange.withValues(alpha: 0.5),
                            ),
                            padding: const EdgeInsets.symmetric(vertical: 7),
                            textStyle: ts(11, w: FontWeight.w600),
                          ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          S.of(context).manualLocationHelp,
      ...
      builder: (context, _) {
        ...
        return SettingsPageShell(
          ...
          body: Column(
            children: [
              _connBanner(),
              if (_configDirty) ...[SizedBox(height: 12), _reconnectButton()],
              SizedBox(height: 16),
              SettingsSectionCard(
                ...
                children: [
                  ...
                  SettingsInput(
                    S.of(context).passcode,
                    _pass,
                    tip: S.of(context).passcodeTip,
                    onChanged: (v) {
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: ts(11, c: C.orange.withValues(alpha: 0.8)),
                ),
              ],
            ),
          ),
      ...
      children: [
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(S.of(context).rangeFilterDesc, style: ts(11, c: C.slate)),
            ],
          ),
        ),
        SettingsSwitch(
          S.of(context).filterCenterFollows,
          value: st.filterFollow,
          color: C.cyan,
          onChanged: (v) {
            st.filterFollow = v;
            _checkConfigDirty();
            ...
            onPressed: () {
              if (st.myLat != null && st.myLng != null) {
                ...
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(SnackBar(content: Text(S.of(context).noFixYet)));
              }
            },
            icon: Icon(Icons.my_location_rounded, size: 15),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  '${S.of(context).filterRule}: ${st.filterString}',
                  style: ts(11, c: C.slate, h: 1.4),
                ),
              ),
            ],
      ...
      children: [
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(S.of(context).receiveFilterDesc2, style: ts(11, c: C.slate)),
            ],
          ),
        ),
        // ── 国家/地区分组 ──
        Padding(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: 6),
              Text(
                '${S.of(context).receiveCountries} (${st.receiveCountries.length})',
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(S.of(context).receiveCountryDesc, style: ts(10, c: C.grey)),
              SizedBox(height: 8),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 6),
                      Text(
                        S.of(context).noCountriesSelected,
                        style: ts(11, c: C.grey),
                      ),
                    ],
                  ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(' ${e.key}', style: ts(10, c: C.grey)),
                      ],
                    ),
                  ),
                ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(
                    ...
                    size: 16,
                    color: st.themeColor.isEmpty ? C.ink : C.grey,
                  ),
                ),
              ),
            ],
            ...
            child: SegmentedButton<String>(
              ...
              style: ButtonStyle(
                ...
                foregroundColor: WidgetStateProperty.resolveWith(
                  (s) =>
                      s.contains(WidgetState.selected) ? Colors.white : C.blue,
                ),
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) => SettingsPageShell(
        ...
        subtitle: S.of(context).chatSettingsDetail,
        ...
        body: Column(
          children: [
            SettingsSectionCard(
              ...
              children: [
                SettingsRow2(
                  S.of(context).messageCountLabel,
                  S.of(context).countEntries(st.messages.length),
                ),
                SettingsRow2(
                  ...
                  S
                      .of(context)
                      .countItems(
                        st.stations.where((s) => s.favorite || s.manual).length,
                      ),
                ),
              ],
            ),
            ...
            SettingsSectionCard(
              ...
              children: [
                _navRow(
                  ...
                  iconColor: C.purple,
                  title: S.of(context).manageContacts,
  ...
  void _confirmClearMessages() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        title: Text(
          S.of(context).clearMessages,
          style: ts(16, w: FontWeight.w700),
        ),
        content: Text(
          S.of(context).deleteAllChatsConfirm(st.messages.length),
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text(S.of(context).chatCleared)),
              );
            },
            style: FilledButton.styleFrom(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      S.of(context).countItems(contacts.length),
  ...
  Widget _contactFilterChip(String label, bool sel, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Text(
          label,
          style: ts(11, c: sel ? Colors.white : C.slate, w: FontWeight.w600),
        ),
      ),
    );
  }
  ...
  void _addContactSubmit(
    ...
    if (call.length < 3) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text(S.of(context).callsignMin3)));
      return;
    }
  ...
  void _confirmRemoveContact(String call, VoidCallback onDone) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(S.of(context).deleteContactConfirm(call), style: ts(13)),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text(S.of(context).cancel, style: ts(13, c: C.grey)),
          ...
          FilledButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(S.of(context).contactDeleted(call)),
                  duration: const Duration(seconds: 2),
                ),
              );
            },
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) => SettingsPageShell(
        ...
        subtitle: S.of(context).dataSettingsSubtitle,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      _clearDataItem(
                        S.of(context).stationListTitle,
                        S.of(context).countItems(st.stations.length),
                      ),
                      _clearDataItem(
                      ...
                      _clearDataItem(
                        ...
                        S.of(context).countItems(st.chatGroups.length),
                      ),
                      _clearDataItem(
                        S.of(context).logs,
                        S.of(context).countEntries(st.logs.length),
                      ),
                      _clearDataItem(
                        S.of(context).packets,
                        S.of(context).countItems(st.packets.length),
                      ),
                      SizedBox(height: 10),
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                S.of(context).irreversibleKeepSettings,
  ...
  void _confirmRestartOobe() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        title: Text(
          S.of(context).restartWizardTitle,
          style: ts(16, w: FontWeight.w700),
        ),
        content: Text(
          S.of(context).confirmRestartOobe,
        ...
        body: Column(
          children: [
            SettingsFold(
              ...
              children: [
                SettingsSwitch(
                  S.of(context).allowLandscape,
                  value: st.labLandscape,
                  color: C.cyan,
            ...
            SettingsFold(
              ...
              children: [
                SettingsSwitch(
                  S.of(context).simData,
                  value: st.devMode,
                  onChanged: st.setDevMode,
                ),
                SettingsRow2(
                  S.of(context).rxTx,
                  '${st.packetsRx} / ${st.packetsTx}',
                ),
                SettingsRow2(
                  S.of(context).stationCount2,
                  '${st.stations.length}',
                ),
                SettingsRow2(S.of(context).connection, st.connInfo),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        maxLines: 2,
                        decoration: InputDecoration(
                          hintText: S.of(context).packetParseHint,
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              style: OutlinedButton.styleFrom(
                                ...
                                side: BorderSide(
                                  color: C.purple.withValues(alpha: 0.5),
                                ),
                                padding: const EdgeInsets.symmetric(
                                  vertical: 8,
                                ),
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              onPressed: () {
                                ...
                                setState(
                                  () =>
                                      _devResult = S.of(context).clearedPackets,
                                );
                              },
